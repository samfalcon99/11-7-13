...
//Name: stickman.ma
//Last modified: Tue, Nov 05, 2013 02:23:19 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.40557006057245115 7.6642349268126964 4.682684661215883 ;
	setAttr ".r" -type "double3" -26.138352729503875 361.79999999992413 4.9720701062413179e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 5.0157170469760137;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" -0.49646343782174496 4.2084755864947603 0.39069738880922955 ;
	setAttr ".s" -type "double3" 0.35848407042775005 0.85884219796825878 0.23316301021644201 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".vt[0:7]"  -1.42890286 -1.42994082 1.54476583 1.42890286 -1.42994082 1.54476583
		 -1.42890286 1.42994082 1.54476583 1.42890286 1.42994082 1.54476583 -1.42890286 1.42994082 -1.54476583
		 1.42890286 1.42994082 -1.54476583 -1.42890286 -1.42994082 -1.54476583 1.42890286 -1.42994082 -1.54476583;
...
createNode polyCube -n "polyCube1";
	setAttr ".w" 2.8578056353062697;
	setAttr ".h" 2.859881664634969;
	setAttr ".d" 3.0895315865551805;
	setAttr ".cuv" 4;
createNode polySphere -n "polySphere1";
	setAttr ".r" 1.2513807935575008;
...
createNode animCurveTL -n "pCube5_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -0.040099955404365173 8 -0.040099955404365173
		 16 -0.040099955404365173 24 -0.040099955404365173;
createNode animCurveTL -n "pCube5_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 2.9293709020561614 8 2.9293709020561614
		 16 2.9293709020561614 24 2.9293709020561614;
createNode animCurveTL -n "pCube5_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.45848678511803875 8 0.45848678511803875
		 16 0.45848678511803875 24 0.45848678511803875;
createNode animCurveTA -n "pCube5_rotateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 8 -33.752421179122805 16 33.752 24 0;
...
createNode animCurveTA -n "pCube5_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 5.941 8 5.9410000000000238 16 5.9410000000000238
		 24 5.9410000000000238;
createNode animCurveTU -n "pCube5_scaleX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.24287811395087128 8 0.24287811395087128
		 16 0.24287811395087128 24 0.24287811395087128;
createNode animCurveTU -n "pCube5_scaleY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.58187794223339806 8 0.58187794223339806
		 16 0.58187794223339806 24 0.58187794223339806;
createNode animCurveTU -n "pCube5_scaleZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.15797129310907734 8 0.15797129310907734
		 16 0.15797129310907734 24 0.15797129310907734;
createNode animCurveTL -n "pCube4_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -0.87625955265666 8 -0.87625955265666
		 16 -0.87625955265666 24 -0.87625955265666;
...
createNode animCurveTA -n "pCube4_rotateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 8 31.883 16 -31.883 24 0;
...
createNode animCurveTA -n "pCube4_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -5.9406540697152153 8 -5.9406540697152153
		 16 -5.9406540697152153 24 -5.9406540697152153;
...
createNode animCurveTL -n "pCube2_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -1.3687891141953794 8 -1.3687891141953794
		 16 -1.3687891141953794 24 -1.3687891141953794;
createNode animCurveTL -n "pCube2_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 4.3634987064560304 8 4.3634987064560304
		 16 4.3634987064560304 24 4.3634987064560304;
...
createNode animCurveTA -n "pCube2_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -52.198068968247284 8 -52.198068968247284
		 16 -52.198068968247284 24 -52.198068968247284;
createNode animCurveTU -n "pCube2_scaleX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.26494852253581658 8 0.26494852253581658
		 16 0.26494852253581658 24 0.26494852253581658;
createNode animCurveTU -n "pCube2_scaleY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.63475336901745161 8 0.63475336901745161
		 16 0.63475336901745161 24 0.63475336901745161;
createNode animCurveTU -n "pCube2_scaleZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.17232619288532777 8 0.17232619288532777
		 16 0.17232619288532777 24 0.17232619288532777;
createNode animCurveTL -n "pCube3_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.29693454133312019 8 0.29693454133312019
		 16 0.29693454133312019 24 0.29693454133312019;
createNode animCurveTL -n "pCube3_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 4.47935428458372 8 4.47935428458372 16 4.47935428458372
		 24 4.47935428458372;
...
createNode animCurveTA -n "pCube3_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 52.198 8 52.198 16 52.198 24 52.198;
...
createNode animCurveTL -n "pSphere1_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  25 -0.48277296502624367 32 -0.48277296502624367
		 40 -0.48277296502624367 48 -0.48277296502624367;
createNode animCurveTL -n "pSphere1_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  25 5.8429381515608707 32 6.7872037557705509
		 40 6.3552016447487709 48 5.843;
createNode animCurveTL -n "pSphere1_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  25 0.39568727992300268 32 0.39568727992300268
		 40 0.39568727992300268 48 0.39568727992300268;
createNode animCurveTU -n "pSphere1_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  25 1 32 1 40 1 48 1;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
createNode animCurveTA -n "pSphere1_rotateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  25 0 32 0 40 0 48 0;
...
createNode animCurveTU -n "pSphere1_scaleX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  25 0.48382505073627097 32 0.48382505073627097
		 40 0.48382505073627097 48 0.48382505073627097;
